...
│   ├── tmux-claude-audit       # Static quality checks for all bin/ scripts and tmux.conf wiring
│   └── tmux-claude-test        # Regression tests for bin/ scripts (skips tmux/zsh if unavailable)
└── README.md
```
